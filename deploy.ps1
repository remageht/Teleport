...
& 'C:\Android\sdk\platform-tools\adb.exe' install -r 'C:\dev\radiotrade\dist\TelePort_1.4.0_Android_arm64-v8a.apk' | Select-Object -Last 1
Start-Process 'C:\dev\radiotrade\dist\TelePort_1.4.0_Windows_x64\TelePort.exe'
Start-Sleep 4
